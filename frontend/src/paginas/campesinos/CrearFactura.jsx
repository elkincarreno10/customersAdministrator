...
const CrearFacturaCampesino = () => {

  const { campesinoFacturas, nuevaFactura, alerta, setAlerta } = useCampesinos()
  ...
  const agregarFactura = e => {
    ...
    nuevaFactura({ descripcion, saldo, fecha, campesinoId: campesinoFacturas })
  ...
  return (
    <div className="flex-1 max-w-2xl mx-auto mt-16 p-5">
      <div className="flex justify-between items-center">
        ...
        <Link to={`/facturas-campesino/${campesinoFacturas}`} className="bg-blue-400 hover:bg-blue-600 text-white rounded-lg p-2">Volver</Link>
      </div>
...
export default CrearFacturaCampesino