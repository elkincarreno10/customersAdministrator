...
const CrearObrero = () => {
  ...
  const { nuevoObrero, alerta, setAlerta } = useObreros()

  const [ name, setName ] = useState('')

  const agregarObrero = e => {
    e.preventDefault()
  ...
  return (
    <div className="flex-1 max-w-2xl mx-auto mt-16 p-5">
      <div className="flex justify-between items-center">
        <h1 className="font-bold text-xl mb-6">Agregar Nuevo Obrero</h1>
      ...
      >
        <div className="flex gap-1 items-center">
            ...
            <input 
                ...
                type="text"
                placeholder="Ingresa el nombre del Nuevo Obrero"
                id="name"
                name='name'
                value={name}
