...
const EditarFacturaCliente = () => {

  const { clienteFacturas, actualizarFactura, facturaEditar, alerta, setAlerta } = useClientes()
  ...
  const handleActualizarFactura = e => {
    ...
    actualizarFactura({ descripcion, saldo, fecha, clienteId: clienteFacturas })
  }
...
export default EditarFacturaCliente