...
const EditarAbonoCliente = () => {

  const { clienteAbonos, actualizarAbono, abonoEditar, alerta, setAlerta } = useClientes()
  ...
  const handleActualizarAbono = e => {
    ...
    actualizarAbono({ descripcion, saldo, fecha, clienteId: clienteAbonos })
  }
  ...
  return (
    <div className="flex-1 max-w-2xl mx-auto mt-16 p-5">
      <div className="flex justify-between items-center">
        ...
        <Link to={`/abonos-cliente/${clienteAbonos}`} className="bg-blue-400 hover:bg-blue-600 text-white rounded-lg p-2">Volver</Link>
      </div>
...
export default EditarAbonoCliente