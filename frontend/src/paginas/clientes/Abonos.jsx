...
const AbonosCliente = () => {
    ...
    const { abonos, setAbonoEditar, eliminarAbono, alerta, cargando } = useClientes()


    const handleEditarAbono = abono => {
        setAbonoEditar(abono)
        navigate('/editar-abono-cliente')
    }
  ...
  return (
    <div className="bg-gray-50 flex-1 flex flex-col gap-3 py-10 px-10 lg:px-24">
        ...
        <div className="flex justify-between">
            <Link to='/crear-abono-cliente' className="bg-blue-400 hover:bg-blue-600 text-white rounded-lg p-2 text-center w-32 mb-2">Nuevo Abono</Link>
