...
const CrearAbonoCliente = () => {

  const { clienteAbonos, nuevoAbono, alerta, setAlerta } = useClientes()
  ...
  const agregarAbono = e => {
    ...
    nuevoAbono({ descripcion, saldo, fecha, clienteId: clienteAbonos })
...
export default CrearAbonoCliente